...
## 📌 Overview
This group presentation focuses on the design and analysis of a **Hotel Revenue Management System** built using Power BI.  
The project analyzes booking, customer, room, and service data to improve **occupancy, pricing, and overall revenue performance** using industry-standard KPIs and interactive dashboards.

A **star schema data model** forms the backbone of the system, enabling accurate calculation of **Occupancy Rate, Average Daily Rate (ADR), and Revenue per Available Room (RevPAR)**, along with guest segmentation, forecasting, and revenue strategy analysis.
...
## 💡 Business Impact
- Unified raw data into a robust analytical model  
- Delivered 360° insights into hotel operations and guest behavior  
- Enabled data-driven pricing, upselling, and demand forecasting  
- Supported strategic decision-making for sustainable revenue growth  
...
- **Interactive Dashboards & What-If Analysis**

---

## ✅ Conclusion
This project demonstrates how **data-driven revenue management** can significantly improve hotel performance.  
By combining strong data modeling, insightful KPIs, guest analytics, forecasting, and strategy dashboards, the system empowers hotel management to make informed, profitable decisions.
